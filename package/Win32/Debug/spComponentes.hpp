...
// (DO NOT EDIT: machine generated header) 'spComponentes.dpk' rev: 33.00 (Windows)

#ifndef SpcomponentesHPP
#define SpcomponentesHPP
...
#include <FireDAC.Phys.hpp>	// (FireDACCommonDriver)
// PRG_EXT: .bpl
// BPI_DIR: C:\Users\Gabriel\Documents\Embarcadero\Studio\Projects\Softplan\package\lib
// OBJ_DIR: C:\Users\Gabriel\Documents\Embarcadero\Studio\Projects\Softplan\package\lib
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Spcomponentes
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Spcomponentes */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SPCOMPONENTES)
using namespace Spcomponentes;
#endif
#pragma pack(pop)
#pragma option pop
